...
namespace Cryptonite.ECDH.Core.Op
{
    internal static class FieldElementOperations
    {
        ...
        internal static FieldElement FromBytes(Span<byte> data, int offset = 0)
        {
            long Load3(Span<byte> data3, int offset3)
            {
                uint result;
            ...
            long Load4(Span<byte> data4, int offset4)
            {
                uint result;
        ...
        /// <param name="h"></param>
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        internal static void ToBytes(Span<byte> s, ref FieldElement h, int offset = 0)
        {
            var hr = Reduce(ref h);
            /*
